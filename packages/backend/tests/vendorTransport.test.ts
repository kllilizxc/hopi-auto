...
const bundle = {
  ...
  browserHome: '/tmp/hopi-home',
  browserTargetsFile: '/tmp/run/context/browser-targets.json',
  ...
  test('keeps the raw process transport path unchanged', async () => {
    ...
    expect(command).toEqual({
      ...
      env: {
        ...
        HOPI_BROWSER_HOME: bundle.browserHome,
        HOPI_BROWSER_TARGETS_FILE: bundle.browserTargetsFile,
