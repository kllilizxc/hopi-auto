...
function generatorPrompt() {
  return [
    ...
    'Before success, reconcile the candidate and observed evidence against every accepted criterion; a prior rejection and its findings do not narrow the Work.',
