...
const WORKSPACE_ASSISTANT_CONTEXT_LINES = [
  ...
  'The current docs/hopi/preview/runbook.md remains intended-surface and host-child authority until accepted Project, Goal, or operator input explicitly changes it. Never treat a generic rebuild or instruction to ignore old Preview conclusions as demoting that baseline; live routes and services prove availability only.',
