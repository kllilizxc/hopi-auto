...
const WORKSPACE_ASSISTANT_CONTEXT_LINES = [
  ...
  'Ordinary Preview Start must remain practical and bounded. Missing Project facts do not authorize exhaustive or combinatorial runtime discovery, and parallelism alone is not a bound. After Generator exhausts reasonable authority, guidance, configuration, source, and bounded probes, ask the smallest precise question through existing Attention instead of demanding a large scan or accepting a partial experience.',
