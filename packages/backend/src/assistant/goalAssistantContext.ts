...
\`\`\`json
{
  ...
  "actions": [
    ...
    },
    {
      ...
      "sourceResponseFormat": "optional literal 'labeled_sections', 'ordered_items', 'ordered_blocks', 'question_blocks', 'question_spans', 'question_closing_spans', 'question_closing_blocks', 'inline_topics', 'topic_sentences', 'topic_spans', 'topic_closing_spans', 'topic_closing_blocks', 'topic_paragraphs', or 'topic_blocks' when sourceResponse should be interpreted as labeled answers, ordered reply items, ordered reply blocks, question-answer blocks, inline question-answer spans, question-closing answer spans whose final sentence is the question, question-closing answer blocks whose final paragraph is the question, inline topic clauses, sentence-level topic mentions, anchored topic sentence spans with continuation sentences, topic-closing sentence spans whose final sentence names the topic, topic-closing paragraph blocks whose final paragraph names the topic, paragraph-level topic mentions, or anchored topic blocks with continuation paragraphs",
      ...
      "followThrough": {
        ...
        "reuseTaskRef": "optional current planning task ref to reuse only for the first child workflow",
        "reuseGroupKey": "optional current grouped planning surface to reuse only for the first child workflow when that child is planning_batch",
        "inferRemainingAnswers": "optional boolean; when true with sourceResponseFormat question_blocks, question_spans, question_closing_spans, question_closing_blocks, topic_sentences, topic_spans, topic_closing_spans, topic_closing_blocks, topic_paragraphs, or topic_blocks, runtime also captures the remaining unclaimed planner answers onto the root shared workflow answers after child explicit answers consume their own items",
        "answers": [
          {
            "summary": "optional shared user answer summary",
    ...
    },
    {
      ...
      "inferOpenDecisions": "optional boolean; when true with sourceResponseFormat labeled_sections, ordered_items, ordered_blocks, question_blocks, question_spans, question_closing_spans, question_closing_blocks, inline_topics, topic_sentences, topic_spans, topic_closing_spans, topic_closing_blocks, topic_paragraphs, or topic_blocks, runtime also resolves matching current open decisions you did not repeat in answers[]",
      "inferDecisionTopics": "optional boolean; when true with sourceResponseFormat labeled_sections, inline_topics, question_blocks, question_spans, question_closing_spans, question_closing_blocks, topic_sentences, topic_spans, topic_closing_spans, topic_closing_blocks, topic_paragraphs, or topic_blocks, runtime also turns remaining unclaimed labeled sections, inline topic clauses, question blocks, question spans, question-closing spans, question-closing blocks, topic sentence spans, topic-closing sentence spans, topic-closing paragraph blocks, topic paragraphs, or topic blocks into durable decision topics",
      "sourceResponseFormat": "optional literal 'labeled_sections', 'ordered_items', 'ordered_blocks', 'question_blocks', 'question_spans', 'question_closing_spans', 'question_closing_blocks', 'inline_topics', 'topic_sentences', 'topic_spans', 'topic_closing_spans', 'topic_closing_blocks', 'topic_paragraphs', or 'topic_blocks' when sourceResponse should be interpreted as labeled answers, ordered reply items, ordered reply blocks, question-answer blocks, inline question-answer spans, question-closing answer spans whose final sentence is the question, question-closing answer blocks whose final paragraph is the question, inline topic clauses, sentence-level topic mentions, anchored topic sentence spans with continuation sentences, topic-closing sentence spans whose final sentence names the topic, topic-closing paragraph blocks whose final paragraph names the topic, paragraph-level topic mentions, or anchored topic blocks with continuation paragraphs",
...
- When there is no existing durable decision surface yet but one structured reply already names the durable decision topics, prefer "record_answers" with "inferDecisionTopics": true plus root "sourceResponseFormat": "labeled_sections", "inline_topics", "question_blocks", "question_spans", "question_closing_spans", "question_closing_blocks", "topic_sentences", "topic_spans", "topic_closing_spans", "topic_closing_blocks", "topic_paragraphs", or "topic_blocks" so runtime can create those durable decision topics from the remaining unclaimed topic pairs after planner-only answers are reserved.
...
- When "inferDecisionTopics" or "followThrough.inferRemainingAnswers" consumes "inline_topics", "topic_sentences", "topic_spans", "topic_closing_spans", "topic_closing_blocks", "topic_paragraphs", or "topic_blocks" and there is no explicit question text to preserve, runtime now synthesizes one canonical prompt from the inferred topic summary automatically; only set explicit item-level "prompt" when you need to override that canonical wording.
