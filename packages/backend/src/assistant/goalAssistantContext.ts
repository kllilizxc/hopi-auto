...
\`\`\`json
{
  ...
  "actions": [
    ...
    },
    {
      ...
      "sourceResponseFormat": "optional literal 'labeled_sections', 'ordered_items', 'ordered_blocks', 'question_blocks', 'question_spans', 'question_closing_spans', 'question_closing_blocks', 'inline_topics', 'topic_sentences', 'topic_spans', 'topic_middle_spans', 'topic_closing_spans', 'topic_closing_blocks', 'topic_paragraphs', 'topic_middle_blocks', or 'topic_blocks' when sourceResponse should be interpreted as labeled answers, ordered reply items, ordered reply blocks, question-answer blocks, inline question-answer spans, question-closing answer spans whose final sentence is the question, question-closing answer blocks whose final paragraph is the question, inline topic clauses, sentence-level topic mentions, anchored topic sentence spans with continuation sentences, topic-middle sentence spans whose topic-bearing sentence sits between leading and trailing continuation sentences, topic-closing sentence spans whose final sentence names the topic, topic-closing paragraph blocks whose final paragraph names the topic, paragraph-level topic mentions, topic-middle paragraph blocks whose topic-bearing paragraph sits between leading and trailing continuation paragraphs, or anchored topic blocks with continuation paragraphs",
    ...
    },
    {
      ...
      "inferDecisionTopics": "optional boolean; when true with sourceResponseFormat labeled_sections, inline_topics, question_blocks, question_spans, question_closing_spans, question_closing_blocks, topic_sentences, topic_spans, topic_middle_spans, topic_closing_spans, topic_closing_blocks, topic_paragraphs, topic_middle_blocks, or topic_blocks, runtime also turns remaining unclaimed labeled sections, inline topic clauses, question blocks, question spans, question-closing spans, question-closing blocks, topic sentence spans, topic-middle sentence spans, topic-closing sentence spans, topic-closing paragraph blocks, topic paragraphs, topic-middle paragraph blocks, or topic blocks into durable decision topics",
      "sourceResponseFormat": "optional literal 'labeled_sections', 'ordered_items', 'ordered_blocks', 'question_blocks', 'question_spans', 'question_closing_spans', 'question_closing_blocks', 'inline_topics', 'topic_sentences', 'topic_spans', 'topic_middle_spans', 'topic_closing_spans', 'topic_closing_blocks', 'topic_paragraphs', 'topic_middle_blocks', or 'topic_blocks' when sourceResponse should be interpreted as labeled answers, ordered reply items, ordered reply blocks, question-answer blocks, inline question-answer spans, question-closing answer spans whose final sentence is the question, question-closing answer blocks whose final paragraph is the question, inline topic clauses, sentence-level topic mentions, anchored topic sentence spans with continuation sentences, topic-middle sentence spans whose topic-bearing sentence sits between leading and trailing continuation sentences, topic-closing sentence spans whose final sentence names the topic, topic-closing paragraph blocks whose final paragraph names the topic, paragraph-level topic mentions, topic-middle paragraph blocks whose topic-bearing paragraph sits between leading and trailing continuation paragraphs, or anchored topic blocks with continuation paragraphs",
...
- When there is no existing durable decision surface yet but one structured reply already names the durable decision topics, prefer "record_answers" with "inferDecisionTopics": true plus root "sourceResponseFormat": "labeled_sections", "inline_topics", "question_blocks", "question_spans", "question_closing_spans", "question_closing_blocks", "topic_sentences", "topic_spans", "topic_middle_spans", "topic_closing_spans", "topic_closing_blocks", "topic_paragraphs", "topic_middle_blocks", or "topic_blocks" so runtime can create those durable decision topics from the remaining unclaimed topic pairs after planner-only answers are reserved.
...
- When "inferDecisionTopics" or "followThrough.inferRemainingAnswers" consumes "question_blocks", "question_spans", "question_closing_spans", or "question_closing_blocks", runtime now preserves the matched question text as the durable "prompt" automatically; only set explicit item-level "prompt" when you need to override that canonical question wording.
