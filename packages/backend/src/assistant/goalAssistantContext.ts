...
\`\`\`json
{
  ...
  "actions": [
    ...
    },
    {
      ...
      "sourceResponseFormat": "optional literal 'labeled_sections', 'ordered_items', 'inline_topics', 'topic_sentences', or 'topic_paragraphs' when sourceResponse should be interpreted as labeled answers, ordered reply items, inline topic clauses, sentence-level topic mentions, or paragraph-level topic mentions",
    ...
    },
    {
      ...
      "inferOpenDecisions": "optional boolean; when true with sourceResponseFormat labeled_sections, ordered_items, inline_topics, topic_sentences, or topic_paragraphs, runtime also resolves matching current open decisions you did not repeat in answers[]",
...
- When current Goal state already contains the relevant open durable decisions and one structured reply answers them directly, prefer "record_answers" with "inferOpenDecisions": true plus root "sourceResponseFormat": "labeled_sections", "ordered_items", "inline_topics", "topic_sentences", or "topic_paragraphs" instead of repeating those same decision topics again inside "answers".
