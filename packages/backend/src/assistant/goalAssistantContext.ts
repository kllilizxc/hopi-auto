...
\`\`\`json
{
  ...
  "actions": [
    ...
    },
    {
      ...
      "sourceResponseFormat": "optional literal 'labeled_sections', 'ordered_items', 'ordered_blocks', 'question_blocks', 'question_spans', 'inline_topics', 'topic_sentences', 'topic_spans', 'topic_closing_spans', 'topic_closing_blocks', 'topic_paragraphs', or 'topic_blocks' when sourceResponse should be interpreted as labeled answers, ordered reply items, ordered reply blocks, question-answer blocks, inline question-answer spans, inline topic clauses, sentence-level topic mentions, anchored topic sentence spans with continuation sentences, topic-closing sentence spans whose final sentence names the topic, topic-closing paragraph blocks whose final paragraph names the topic, paragraph-level topic mentions, or anchored topic blocks with continuation paragraphs",
